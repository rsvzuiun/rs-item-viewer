...
const body: Body = [
  {
    name: "ネックレス",
    query: "type=8",
    img: [128, -1, 1051, 1052, 2633, 2633, 2949, 3368, 3650, 4154, 4523, 1952, 2967],
  },
  {
    name: "ヘルメット",
    query: "type=0",
    img: [89, -1, 325, 999, 2647, 2647, 2954, 3389, 3635, 4146, 4534, 90, 3390],
  },
  {
    name: "冠",
    query: "type=1",
    img: [96, -1, 1007, 1004, 2648, 2648, 2962, 3387, 3637, 4147, 4519, 327, 3388],
  },
  {
    name: "イヤリング",
    query: "type=10",
    img: [146, -1, 1067, 1066, 2640, 2640, 2963, 3371, 3652, 4158, 4521, 4254, 2971],
  },
  {
    name: "マント",
    query: "type=11",
    img: [152, -1, 387, 1070, 2638, 2638, 2952, 3383, 3657, 4161, 4522, 4342, 2966],
  },
  {
    name: "ベルト",
    query: "type=6",
    img: [116, -1, 351, 352, 2643, 2643, 2947, 3392, 3645, 4148, 4526, 2882, 2959],
  },
  {
    name: "グローブ",
    query: "type=2&group=p",
    img: [100, 1132, 331, 1015, 2645, 2645, 2961, 3380, 3639, 4144, 4529, 2879, 2948],
  },
  {
    name: "ブレスレット",
    query: "type=5",
    img: [110, -1, 1024, -1, -1, -1, -1, -1, 3641, 4143, 4532, 4341, 4531],
  },
  {
    name: "投擲機",
    query: "type=3",
    img: [106, -1, 337, 1017, -1, -1, -1, -1, -1, -1, -1, -1, -1],
  },
  {
    name: "共用鎧",
    query: "type=16",
    img: [157, 1133, 393, 1076, 2649, 2649, 2945, 3363, 3659, 4153, 4518, 2880, 2969],
  },
  {
    name: "専用鎧",
    query: "type=17",
  ...
  },
  {
    ...
    img: [122, -1, 358, 1037, 2636, 2636, 2951, 3376, 3647, 4151, 4527, 2883, 2958],
  },
  {
    name: "リング",
    query: "type=9",
    img: [138, -1, 374, 1061, -1, -1, -1, 3395, -1, -1, -1, 1620, 3396],
  },
  {
    name: "盾",
    query: "type=19",
  ...
  },
  {
    name: "エネルギーチャージャー",
    query: "type=83",
    img: [4996, -1, 5001, -1, -1, -1, -1, -1, -1, -1, -1, 5002, -1],
  },
];
